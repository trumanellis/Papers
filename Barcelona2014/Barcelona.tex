...
%\documentclass[11pt,c,draft]{beamer}
\usefonttheme[onlymath]{serif}

\usepackage{beamerthemeMyself}
\usepackage{float}
\usepackage{epsfig}
\usepackage{graphics}
\usepackage{fancybox}
...
\setbeamercolor{fgwh}{fg=white}
\setbeamercolor{yell}{fg=yellow}
...
\newcommand{\redbulletS}{\includegraphics[width=.3cm]{red-bullet-on-white.ps}}
\newcommand{\greenbulletS}{\includegraphics[width=.3cm]{green-bullet-on-white.ps}}
\newcommand{\fin}{\end{document}}
...
\subtitle{Three DPG Punchlines}



%\date[Xiangtan University, Jun 30 - Jul 6, 2014]{
%Hunan Key Laboratory\\ for Computation and Simulation 
%in Science and Engineering \\
%Xiangtan University, Changsha, June 30 - July 6, 2014
%}

%\date[Durham, Jul 7 - Jul 16, 2014]{
%London Mathematical Society - EPSRC Durham Symposium:\\
%Building bridges: connections and challenges \\
%in modern approaches to partial differential equations\\
%Durham, July 7 - July 16, 2014
%}
\date[Barceloma, Jul 20 - Jul 25, 2014]{
...
%\date[Beijing, June 2014]{
%Peking University, Beijing, June 26, 2014
%}
...
%======================================================================
% images
% \pgfdeclareimage[width=0.2\textwidth]{cover}{FIGS/cover.jpg}
%######################################################################
\begin{document}
...
\setbeamercolor{frametitle}{fg=white}   % font color
\setbeamercolor{frametitle}{parent=palette primary} % bg color
%======================================================================
...
\frame{\frametitle{Extrapolation to Compresible NS Equations}
...
%======================================================================
\frame{\frametitle{A bit of history: Optimal test functions of Barret and Morton
\footnote{
\tiny 
\begin{itemize}
