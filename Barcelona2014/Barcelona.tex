...
\footnote{\tiny
J. Chan, L.D., R. Moser, ``A DPG method for steady viscous compressible flow,''
{\em Computers and Fluids}, to appear.
}
}
...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.49\textwidth]{figures_CNS/PlateRe3/mesh0.png}}
\subfigure{\includegraphics[width=0.49\textwidth]{figures_CNS/PlateRe3/mesh12.png}}
\subfigure[Initial mesh]{\includegraphics[width=0.49\textwidth]{figures_CNS/PlateRe3/T0.png}}
\subfigure[12 refinements]{\includegraphics[width=0.49\textwidth]{figures_CNS/PlateRe3/T.png}}
\caption{${\rm Re}= 1000$, initial and final meshes.  }
\end{figure}
}
%\frame{\frametitle{Compressible Navier-Stokes}
%\framesubtitle{Extrapolation to Compressible NS Equations}  %% needed for proper positioning of the logo ...
%\begin{figure}[ht]
%\centering
%\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe3/outflow_profiles.png}}
%\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe3/skinfriction.png}}
%\caption{Comparison with reference results}
%\end{figure}
%}

% Plate movie (Re = 10000)
\frame{\frametitle{Compressible Navier-Stokes}
\framesubtitle{~~}  %% needed for proper positioning of the logo ...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe4/mesh000.png}}
\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe4/T000.png}}
\caption{${\rm Re = 10,000}$, $p = 2$, initial mesh.}
\end{figure}
}
\frame{\frametitle{Compressible Navier-Stokes}
\framesubtitle{Extrapolation to Compressible NS Equations}  %% needed for proper positioning of the logo ...
...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe4/mesh00\n.png}}
\subfigure{\includegraphics[width=0.55\textwidth]{figures_CNS/PlateRe4/T00\n.png}}
\caption{${\rm Re = 10,000}$, $p = 2$, refinement number \n.}
\end{figure}
}
}
}
...
Holden Ramp Problem
\footnote{\tiny
L.D., J.T. Oden, W. Rachowicz, ``A New Finite Element Method for Solving Compressible Navier-Stokes
Equations Based on an Operator Splitting Method and $hp$ Adaptivity,'',
{\em Comput. Methods Appl. Mech. Engrg.}, {\bf 84}, 275-326, 1990.
}
\footnote{\tiny
...
\end{center}
\begin{figure}
\includegraphics[width=.4\textwidth]{./figures_flat_plate/holden.pdf}\\
\caption{${M}_\infty = 6, {\rm Re}_{\rm plate} = 33,936, {\rm Pr} = 0.72, \gamma = 1.4, \theta_\infty = 390^o[{\rm R}]$}
\end{figure}
}
\frame{\frametitle{Compressible Navier-Stokes}
\framesubtitle{~~}  %% needed for proper positioning of the logo ...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.75\textwidth]{figures_CNS/RampMa6Re4/mesh000.png}}
\subfigure{\includegraphics[width=0.75\textwidth]{figures_CNS/RampMa6Re4/T000.png}}
\caption{Mach 6, ${\rm Re \approx 34,000}$, $p = 2$, initial mesh.}
\end{figure}
}
\frame{\frametitle{Compressible Navier-Stokes}
\framesubtitle{~~}  %% needed for proper positioning of the logo ...
...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.75\textwidth]{figures_CNS/RampMa6Re4/mesh00\n.png}}
\subfigure{\includegraphics[width=0.75\textwidth]{figures_CNS/RampMa6Re4/T00\n.png}}
\caption{Mach 6, ${\rm Re \approx 34,000}$, $p = 2$, refinement number \n.}
\end{figure}
}
}
}
...
\begin{center}
{\Large  \bf
From Ph.D. Proposal of Truman Ellis:\\
Space-Time Compressible Navier-Stokes Equations:\\
Sod Shock Tube Problem
\footnote{\tiny
G.A. Sod, ``A Survey of Several Finite Difference Methods for Systems of Nonlinear Hyperbolic Conservation Laws'',
{\em J. Comp. Methods Phys.}, {\bf 27}, 1-31, 1978.
}
...
% ------------------------------------------------------------
\frame{\frametitle{Space-Time Compressible Navier-Stokes}
...
\begin{center}
{\Large  \bf
From Ph.D. Dissertation\footnote{
\tiny Nathan V. Roberts.  {\em A Discontinuous {Petrov-Galerkin} Methodology for Incompressible Flow Problems.} PhD. thesis, University of Texas at Austin, 2013.
} of Nathan V. Roberts:\\
...
%======================================================================
\frame{\frametitle{The simplest singular perturbation problem: }
\framesubtitle{Reaction-dominated diffusion}
$$
\left\{
\begin{array}{rll}
u & = 0 & \text{ on } \Gamma\\
...
\bit
  \item<1->  Elasticity, shells (volumetric, shear, membrane locking)
  \item<2->  Metamaterials
  \item<3->  Wave propagation problems (sonars, cloaking, full wave form inversion in geomechanics)
\eit

}

%======================================================================
\frame{\frametitle{Seismic Inversion
\framesubtitle{Tomography Setting}
}
\begin{center}
\includegraphics[width=0.6\textwidth]{./figures_inversion/lamb.pdf}
\end{center}
}

%======================================================================
\frame{\frametitle{Seismic Inversion
\framesubtitle{Inverse Algorithm}
}
\begin{itemize}
\item Solve state at current guess $m$ using DPG at each frequency for each source
\begin{align*}
\left\{ \begin{array}{ll}
-\Delta u_{\omega, n} - \omega^2 m u_{\omega, n} = 0 &\mbox{ in } \Omega \\
\nabla u_{\omega,n} \cdot \hat{n} = f_n &\mbox{ on } \Gamma_1 \\
u_{\omega, n} = 0 &\mbox{ on } \Gamma_2
\end{array} \right.
\end{align*}
\item Solve adjoint at current guess $m$ and solution $u$ using DPG at each frequency for each source
\begin{align*}
\left\{ \begin{array}{ll}
-\Delta p_{\omega, n} - \omega^2 m p_{\omega, n} = \overline{u_{\omega, n}^{\mbox{obs}} - u_{\omega,n}} &\mbox{ in } \Omega \\
\nabla p_{\omega,n} \cdot \hat{n} = 0 &\mbox{ on } \Gamma_1 \\
p_{\omega, n} = 0 &\mbox{ on } \Gamma_2
\end{array} \right.
\end{align*}
\item Calculate derivative in direction $\tilde{m}$ for use in numerical inversion algorithms
\begin{align*}
(g, \tilde{m})_{L^2(\Omega)} &= \gamma (\nabla m, \nabla \tilde{m})_{L^2(\Omega)} - \sum_\omega \sum_n \omega^2 \Re (\tilde{m} u_{\omega,n},p_{\omega,n})_{L^2(\Omega)}
\end{align*}
\item DPG can invert over higher frequencies resulting in better resolution
\end{itemize}
}

%======================================================================
\frame{\frametitle{Seismic Inversion
\framesubtitle{Elastic Marmousi Problem}
}
\begin{figure}
\begin{center}
  \subfigure[Exact $\mu$]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/exact_mu.png}
  }
  \subfigure[Initial $\mu$]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/initial_mu.png}
  }
  \subfigure[Exact $\lambda$]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/exact_lambda.png}
  }
  \subfigure[Initial $\lambda$]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/initial_lambda.png}
  }
\end{center}
\end{figure}
}
...
\begin{figure}
\begin{center}
  \subfigure[CG $\mu$, low frequency]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/CG_elas_marm_mu.png}
  }
  \subfigure[DPG $\mu$, high frequency]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/DPG_elas_marm_mu.png}
  }
  \subfigure[CG $\lambda$, low frequency]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/CG_elas_marm_lambda.png}
  }
  \subfigure[DPG $\lambda$, high frequency]{
    \includegraphics[width=0.46\textwidth]{./figures_inversion/DPG_elas_marm_lambda.png}
  }
\end{center}
\end{figure}
}
