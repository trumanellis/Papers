...
% We follow a standard residual-Jacobian linearization procedure.
% If $R(U)$ is the nonlinear residual
% We approximate
...
% $\tilde U = \LRc{\tilde\rho,\tilde\bfu,\tilde T,\tilde{\mathbb{D}},\tilde\bfq,\bs0,0,0,\bs0,0}$ is the previous iteration approximation, 
% and $\Delta U=\LRc{\Delta\rho,\Delta\bfu,\Delta T,\Delta\mathbb{D},\Delta\bfq,\hat\bfu,\hat e,\hat t_c,\hat\bft_m,\hat t_e}$ is the update.
