...
\begin{align*}
\Delta\bfF_c&=\Delta\alpha\tilde\bfV_m+\tilde\alpha\Delta\bfV_m\\
\Delta\bbF_m&=
\Delta\alpha\LRp{-\frac{\tilde\bfV_m\otimes\tilde\bfV_m}{\tilde V_e}+(\gamma-1)\bfI}\\
&+\tilde\alpha\LRp{
...
\Delta\bfF_e&=
\Delta\alpha\frac{\tilde\bfV_m}{\tilde V_e}\LRp{\frac{1}{2\tilde V_e}\tilde\bfV_m\cdot\tilde\bfV_m-\gamma}\\
&+\tilde\alpha\LRp{
...
\Delta K&=\LRc{0\,,\,
\Delta\bbD\,,\,
-\frac{\Delta\bfV_m}{\tilde V_e}\cdot\tilde\bbD
+\frac{\tilde\bfV_m}{\tilde V_e^2}\cdot\tilde\bbD\Delta V_e
-\frac{\tilde\bfV_m}{\tilde V_e}\cdot\Delta\bbD}\\
\Delta C_c&=-\Delta\alpha\tilde V_e-\tilde\alpha\Delta V_e\\
\Delta\bfC_m&=\Delta\alpha\tilde\bfV_m+\tilde\alpha\Delta\bfV_m\\
\Delta C_e&=\Delta\alpha\LRp{1-\frac{1}{2\tilde V_e}\tilde\bfV_m\cdot\tilde\bfV_m}
	-\tilde\alpha\frac{1}{\tilde V_e}\tilde\bfV_m\cdot\Delta\bfV_m
	+\tilde\alpha\frac{1}{2\tilde V_e^2}\tilde\bfV_m\cdot\tilde\bfV_m\Delta V_e\\
\Delta M&=\LRc{\frac{1}{\mu}\Delta \bbD\,,\,\frac{Pr}{C_p\mu}\Delta\bfq}\\
\Delta G&=\LRc{-2\LRp{\frac{\Delta\bfV_m}{\tilde V_e}-\frac{\tilde\bfV_m}{\tilde V_e^2}\Delta V_e}\,,\,
