...
10\epsilon\cos(\pi y)\frac{\exp(s_1x)-\exp(r_1x)}{r_1 \exp(-r_1)-s_1 \exp(-s_1)}\,,
\]
where $l=4$,
...
We show robustness for $\epsilon=10^{-2}$ and $10^{-6}$ and for linear, quadratic, and quartic polynomial trial functions.
