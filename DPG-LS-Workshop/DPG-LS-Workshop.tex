...
\begin{frame}[t]
\frametitle{Space-Time Compressible Navier-Stokes}
\framesubtitle{Conservation Variables}
% \begin{columns}[t]
% \begin{column}{0.5\textwidth}
...
\begin{frame}[t]
\frametitle{Space-Time Compressible Navier-Stokes}
\framesubtitle{Entropy Variables}
% \vspace{-4ex}
Change of variables:
...
\mathbb{F}^e_m&=\LRs{\frac{\gamma-1}{(-V_e)^\gamma}}^{\frac{1}{\gamma-1}}\exp\LRs{\frac{-\gamma+V_c-\frac{1}{2V_e}\bfV_m\cdot\bfV_m}{\gamma-1}}\LRp{-\frac{\bfV_m\otimes\bfV_m}{V_e}+(\gamma-1)\bfI}\\
...
\framesubtitle{Enforce with Lagrange Multipliers}
...
{\langle\hat t, 1_K\rangle_{\partial K}-\langle f,1_K\rangle_K}\,,
\end{align*}
...
equations \footfullcite{EllisDemkowiczChan2013}.
\begin{align*}
