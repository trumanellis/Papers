...
% \framesubtitle{Streamwise-Upwind Petrov-Galerkin}
...
\begin{itemize}
  \item Invented for neutron transport\footfullcite{ReedHillDG}
  \item Popular for all kinds of conservation laws
  \item Significant contributions to CFD by Cockburn and Shu\footfullcite{CockburnShuDG}
...
\begin{itemize}
  ...
  \item Tezduyar \etal\footfullcite{Tezduyar1992} developed a deforming-spatial-domain/space-time procedure 
