...
\end{itemize}
\end{column}
\footnotetext{\fullcite{SUPG}}
\footnotetext{\fullcite{VMS}}
...
\]
Hybridized DPG method introduces trace unknowns which facilitates static condensation\footfullcite{HDG}.
\end{frame}
...
\end{itemize}
\end{column}
\footnotetext{\fullcite{GCL}}
\footnotetext{\fullcite{Tezduyar1992}}
\footnotetext{\fullcite{vanderVegtEuler}}
\footnotetext{\fullcite{TentPitcher}}
...
implies that the optimal Petrov-Galerkin method is the most stable Petrov-Galerkin method (assuming exact optimal test functions).
\end{block}
\end{frame}
...
\only<2>{
\centering
Percent Mass Loss at Vertical Mesh Lines
\vspace{-5ex}
}
\begin{columns}
\begin{column}{0.49\textwidth}
