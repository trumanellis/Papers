...
\label{eq:confusionBF}
	...
	\end{aligned}
\end{equation}
where now $\hat t=\trace\LRp{(\bfbeta u-\bfsigma)\cdot\bfn_x+u\cdot n_t}$, and $\hat u$ is as before. Our test functions, $\bftau$ and $n$ live in the same spaces as for the heat equation.
