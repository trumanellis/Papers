...
&\leq\frac{\norm{A_0^{\frac{1}{2}}U}^2}{2}+\frac{\norm{A_0^{-\frac{1}{2}}\vecttwo{\mathcal{F}^*}{C^*}\cdot\Gradxt V}^2}{2}+\epsilon C\norm{\Grad V}^2\\
\end{align*}
indicating that including a term such as $\norm{A_0^{-\frac{1}{2}}\vecttwo{\mathcal{F}^*}{C^*}\cdot\Gradxt V}$ in our norm will produce a robust bound.
