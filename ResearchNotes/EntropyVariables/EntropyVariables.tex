...
In the primitive variable formulation, $\Sigma=\LRc{\mathbb{D},\bfq}$, $U=\LRc{\rho,\bfu,T}$, $\Psi=\LRc{\mathbb{S},\bftau}$, and $V=\LRc{v_c,\bfv_m,v_e}$.
We have the following definitions:
\begin{align*}
M^*\Psi&=\frac{1}{\mu}\mathbb{S}+\frac{Pr}{C_p\mu}\bftau\\
K^*\Grad V&=\frac{1}{\mu}\mathbb{S}+\frac{Pr}{C_p\mu}\bftau\\
G^*\cdot\Grad\Psi&=2\Div\mathbb{S}-\frac{2}{3}\Grad\trace{\mathbb{S}}\\
\end{align*}
