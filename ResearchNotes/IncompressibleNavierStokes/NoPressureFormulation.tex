...
\LRp{\bfu,2\mu\Div\bftau-\tilde\bfu\cdot(\Grad\bfv+(\Grad\bfv)^T)-\frac{\partial v}{\partial t}}\,.
\end{align*}
...
\begin{equation*}
\norm{\LRc{\bfv,\bftau}}^2=\norm{\bftau-\frac{1}{N}\trace(\bftau)\bfI+\Grad\bfv}^2
+\norm{2\mu\Div\bftau-\tilde\bfu\cdot\LRp{\Grad\bfv+(\bfv)^T}-\frac{\partial v}{\partial t}}^2
+\norm{v}^2\,.
\end{equation*}
