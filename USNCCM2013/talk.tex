...
Chan et al\textsuperscript{\cite{ChanHeuerThanhDemkowicz2012}}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\textwidth]{Erickson/modifiedError.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\textwidth]{Erickson/modifiedFlux.pdf}
