...
c..these routines are written in real*10 precision because the 
...
c..local variables
     ...
     1                 efun01,efun02
      integer          i
      real*10          efun01,efun02,eval1,eval2
      real*10          v0,v2,vstar,vmin,
...
c..osmall controls the size of transition regions
      ...
      real*10          iprint,eps,eps2,osmall,pi
      parameter        (iprint = 1,
     1                  eps    = 1.0q-10, 
     2                  eps2   = 1.0q-30, 
     3                  osmall = 1.0q-4,
...
c..common block communication
      ...
      real*10          gamma,gamm1,gamp1,gpogm,xgeom,xg2,rwant,r2,
...
c..local variables
      real*10 l_fun,dlamdv,f_fun,g_fun,h_fun
...
c..local variables
      real*10 l_fun,dlamdv,f_fun,g_fun,h_fun,z
...
c..local variables
      ...
      real*10 function sed_lam_find(v)
      implicit none
      save
...
c..declare the pass
      real*10          v,l_fun,dlamdv,f_fun,g_fun,h_fun
...
c..local variables
      real*10          x1,x2,x3,x4,dx1dv,dx2dv,dx3dv,dx4dv,
...
c..declare 
      external          func 
      integer           n,it,j   
      real*10           func,a,b,s,tnm,del,ddel,x,sum 
...
c..declare 
      external          funk  
      integer           n,it,j   
      real*10           func,funk,a,aa,b,bb,s,tnm,del,ddel,x,sum 
...
c..declare 
      ...
      real*10           a,b,ss,s(jmaxp),h(jmaxp),eps,dss,func
...
c..declare
      ...
      parameter        (nmax=20)
      real*10          xa(n),ya(n),x,y,dy,c(nmax),d(nmax),dif,dift,
     1                 ho,hp,w,den
...
c..are. the last dy added is the error indicator.
      ...
      real*10 function zeroin( ax, bx, f, tol)
...
c..declare
      ...
      real*10           x,sign,factor,rten,temp
