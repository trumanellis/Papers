...
% (we acknowledge that the issue of load balancing and adaptive mesh refinement is still a challenge).
...
% Note that Camellia is flexible and supports rapid application development - once support for a general class of problems is working, adding new variants is easy
...
% Bringing expertise on mathematically rigorous numerical methods.
% Colloborating with other researchers.
