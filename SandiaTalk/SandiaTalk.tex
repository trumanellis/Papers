...
\title[Space-Time DPG for Transient CFD]{Automating Scientific Computing with Discontinuous Petrov-Galerkin Finite Elements}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.8\textwidth]{figs/SpaceTimeSchematic}
\end{figure}
% \bigskip
