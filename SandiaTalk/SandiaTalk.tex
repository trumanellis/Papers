...
\centering
Graph Norm
\includegraphics[width=0.8\textwidth]{figs/Graph_v}\\
\includegraphics[width=0.8\textwidth]{figs/Graph_tau}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\begin{figure}[t]
\centering
Robust Norm
\includegraphics[width=0.8\textwidth]{figs/Robust_v}\\
\includegraphics[width=0.8\textwidth]{figs/Robust_tau}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\centering
Graph Norm
\includegraphics[width=0.8\textwidth]{figs/GraphApprox3_v}\\
\includegraphics[width=0.8\textwidth]{figs/GraphApprox3_tau}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\begin{figure}[t]
\centering
Robust Norm
\includegraphics[width=0.8\textwidth]{figs/RobustApprox3_v}\\
\includegraphics[width=0.8\textwidth]{figs/RobustApprox3_tau}
\end{figure}
\end{column}
\end{columns}
\end{frame}
