...
\item Optimal test function are in the orthogonal complement of constants. % Backup slide
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Locally Conservative DPG}
\framesubtitle{Stability and Robustness Analysis\footfullcite{EllisLC}}
\begin{itemize}
...
\begin{frame}
\frametitle{Space-Time Incompressible Navier-Stokes}
\framesubtitle{Flow Over a Cylinder, \only<1>{Initial Mesh}\only<2>{4 Refinements}}  %% needed for proper positioning of the logo ...
\begin{figure}
\centering
...
\hline
0 & 80             & 31,304       & 1,772   & 453    & 3.91 & 451   & 1.01 \\
1 & 605            & 225,908      & 8,190   & 3,574  & 2.29 & 717   & 4.98 \\
2 & 3,013          & 1,081,598    & 32,008  & 12,076 & 2.65 & 2,648 & 4.56 \\
3 & 9,726          & 3,429,384    &         & 28,744 &      & 6,319 & 4.54 \\
4 & 11,742         & 4,144,674    &         &        &      & 8,510 &      \\
\hline
