...
Priliminary 1D results (2D in space-time), were computable with standard direct solvers,
...
exibits the following convergence history for the iterative solve.
...
\subsection{The Question of Space-Time Slabs}
...
\item Only isotropc refinements are permitted.
